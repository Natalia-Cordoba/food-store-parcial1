...
export const PRODUCTS: Product[] = [
  {
    ...
    stock: 20,
    imagen: "/images/products/pizza_muzarrella.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 15,
    imagen: "/images/products/pizza_napolitana.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 10,
    imagen: "/images/products/pizza_especial_4_quesos.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 30,
    imagen: "/images/products/hamburguesa_clasica.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 25,
    imagen: "/images/products/hamburguesa_bbq_bacon.jpg",
    disponible: true,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 0,
    imagen: "/images/products/hamburguesa_veggie.jpg",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 100,
    imagen: "/images/products/coca_cola_500ml.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 40,
    imagen: "/images/products/jugo_de_naranja_natural.jpg",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 150,
    imagen: "/images/products/agua_mineral_500ml.jpg",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 12,
    imagen: "/images/products/torta_rogel.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 30,
    imagen: "/images/products/helado_artesanal_2_gustos.jpg",
    disponible: true,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 0,
    imagen: "/images/products/brownie_con_helado.jpg",
    disponible: false,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 50,
    imagen: "/images/products/empanadas_de_carne_x6.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 45,
    imagen: "/images/products/empanadas_de_pollo_x6.jpg",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 60,
    imagen: "/images/products/empanadas_de_jamon_y_queso_x6.jpg",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 20,
    imagen: "/images/products/ensalada_cesar.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 18,
    imagen: "/images/products/ensalada_caprese.jpg",
    disponible: true,
    categorias: [categorias[5]],
  },
  {
    ...
    stock: 10,
    imagen: "/images/products/pizza_fugazzeta.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 0,
    imagen: "/images/products/hamburguesa_crispy_chicken.jpg",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 25,
    imagen: "/images/products/ensalada_mixta.jpg",
    disponible: true,
    categorias: [categorias[5]],
  },
]
